...
<button type="button" onclick="location.href='welcome.html'">Back to Previous Page</button>  
 ...
 <TR>
	...
	while(i.hasNext())
	{
	    ...
	    <td><% out.print(f2.getDeparture_time()); %></td>
         ...
         <input type="submit" value="Update"  style="background-color:#04AA6D; cursor:pointer; color:white; border:none; padding:10px 15px; font-weight:700">
        </form></td>
        <td><form action="AdminDelete.jsp">
        <input type="hidden" name="flynum" value="<%=f2.getFly_Num()%>"/>
        <input type="submit" value="Delete" style="background-color:#f44336; cursor:pointer; color:white; border:none; padding:10px 15px; font-weight:700">
        </form></td>
